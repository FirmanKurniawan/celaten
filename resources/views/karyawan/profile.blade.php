...
<div class="card">
		<div class="row">
			<div class="col-12 col-md-6 col-lg-6">
				...
				<form action="/karyawan/update_karyawan" method="POST" enctype="multipart/form-data">
					@csrf
					<?php 
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<center>
							<div class="form-group">
								<img src="{{url('foto/karyawan/'. $q->foto)}}" alt="Nature" class="responsive" id="blah1" style="width: 60%;height: 60%; border-radius: 10%;">
							</div>
							</center>
							<div class="input-group">
