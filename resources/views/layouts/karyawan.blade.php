        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="{{url('karyawan/profile')}}" class="dropdown-item has-icon">
      ...
      <div class="main-sidebar sidebar-style-2"><br>
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="{{url('karyawan/penilaian-karyawan')}}"><i class="fa fa-trophy"></i> <span>Penilaian Karyawan</span></a></li>
            @endif

            @if($karyawan->user_id === Auth::user()->id)
              <li><a class="nav-link" href="{{url('karyawan/penilaian-diri')}}"><i class="fa fa-trophy"></i> <span>Penilaian Diri</span></a></li>
            @endif
          </ul>
        </aside>
      </div>
